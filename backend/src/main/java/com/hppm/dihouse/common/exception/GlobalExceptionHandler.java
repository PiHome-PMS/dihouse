...
import com.hppm.dihouse.modules.authentication.dto.response.ApiResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(
        ...
        ErrorCode ec = status.is4xxClientError() ? ErrorCode.REQUEST_FAILED : ErrorCode.UNEXPECTED_ERROR;
